...
var urlBase = "http://127.0.0.1:3001/api";
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
     ...
     */
        ...
        /**
         * @ngdoc method
         * @name lbServices.User.tweets#createMany
         * @methodOf lbServices.User.tweets
         *
         * @description
         *
         ...
         * </em>
         */
        R.tweets.createMany = function() {
          var TargetResource = $injector.get("Tweet");
          var action = TargetResource["::createMany::user::tweets"];
          return action.apply(R, arguments);
        };
     ...
     */
        ...
        /**
         * @ngdoc method
         * @name lbServices.User.likes#createMany
         * @methodOf lbServices.User.likes
         *
         * @description
         *
        ...
        R.likes.createMany = function() {
          var TargetResource = $injector.get("Like");
          var action = TargetResource["::createMany::user::likes"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use User.tweets.createMany() instead.
        "::createMany::user::tweets": {
          isArray: true,
          url: urlBase + "/users/:id/tweets",
          method: "POST"
        },
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use User.likes.createMany() instead.
        "::createMany::user::likes": {
          isArray: true,
          url: urlBase + "/users/:id/likes",
          method: "POST"
        },
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
         ...
         */
        "createChangeStream": {
          url: urlBase + "/avatar/change-stream",
          method: "POST"
        },
      }
    );
